...
public class ClassController {
	...
	public String getClassList(@RequestParam(value = "id_user") String id_user,
	...
	public String readClassBoard(@RequestParam(value = "year") int year,
			@RequestParam(value = "semester") int semester,
			@RequestParam(value = "id_course") int id_course,
			@RequestParam(value = "type") int type,
			@RequestParam(value = "date_written") long date_written,
			@RequestParam(value = "writer") String id_writer,
		...
		ClassBoard record = classBoardService
				.getClassBoardAndUpdateReadNum(queryObject);
	...
	public String saveReply(
		 ...
		 */
		return readClassBoard(classBoardReply.getYear(),
				classBoardReply.getSemester(), classBoardReply.getId_course(),
				classBoardReply.getBoard_type(),
				classBoardReply.getBoard_date(),
				classBoardReply.getBoard_writer(), classBoardReply.getPage(),
				classBoardReply.getId_writer(), locale, model);
	}

	@RequestMapping(value = "/classBoardWrite.action", method = RequestMethod.GET)
	public String writeClassBoard_form(@RequestParam(value = "year") int year,
			@RequestParam(value = "semester") int semester,
			@RequestParam(value = "id_course") int id_course,
			@RequestParam(value = "type") int type,
	...
	public String writeClassBoard(
		...
		return getClassBoardList(classBoard.getYear(),
				classBoard.getSemester(), classBoard.getId_course(),
				classBoard.getId_writer(), classBoard.getType(), 0, locale,
				model);
	}

	@RequestMapping(value = "/classBoard.action", method = RequestMethod.GET)
	public String getClassBoardList(@RequestParam(value = "year") int year,
			@RequestParam(value = "semester") int semester,
			@RequestParam(value = "id_course") int id_course,
			@RequestParam(value = "id_user") String id_student,
			@RequestParam(value = "type") int type,
			@RequestParam(value = "page") int page, Locale locale, Model model) {
	...
	public String enterClass(@RequestParam(value = "year") int year,
			@RequestParam(value = "semester") int semester,
			@RequestParam(value = "id_course") int id_course,
