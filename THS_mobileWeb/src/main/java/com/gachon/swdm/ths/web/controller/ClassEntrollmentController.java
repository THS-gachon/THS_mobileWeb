...
public class ClassEntrollmentController {
	@Autowired
	...
	@RequestMapping(value = "/courseEnrollView.action", method = RequestMethod.GET)
	public String viewCourses(@RequestParam(value="department")String department,@RequestParam(value="id_user")String id_student, Locale locale, Model model) {
		...
		return "courseEnroll/course_enroll";
	}
