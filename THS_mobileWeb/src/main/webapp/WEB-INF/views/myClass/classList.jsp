			...
			<div id="classList">
				<table>
					<tr>
						...
						<th><spring:message code="label.myClass.course.professor.name" /></th>
					</tr>
					<c:forEach var="myClass" items="${myClassList}">
						<tr>
							<td><a href="classEnterance.action?year=${myClass.year}&semester=${myClass.semester}&id_course=${myClass.id_course}&type=0&id_student=${member.loginId}">${myClass.title}</a></td>
