...
<a href="classBoardWrite.action?year=${course.year}&semester=${course.semester}&id_course=${course.id_course}&type=${type}&page=${page}"><spring:message
...
<c:if test="${pageNums[0] != 0}">
	<a href="classBoard.action?year=${course.year}&semester=${course.semester}&id_course=${course.id_course}&type=${type}&page=${pageNums[0]-1}">◀</a>
</c:if>
