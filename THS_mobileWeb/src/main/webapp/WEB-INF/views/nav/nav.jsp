...
<table>
	...
	<tr>		
		<td><a href="schoolBoard.action?type=0&page=0&id_user=${member.loginId}"><spring:message
	...
	<tr/>
	<tr>			
		<td><a href="courseEnrollView.action?department=all&id_user=${member.loginId}"><spring:message
