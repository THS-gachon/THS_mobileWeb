	...
	<div id="body">
		...
		<div id="contents">
			<form:form modelAttribute="schoolBoard" method="POST"
				...
				<spring:message code="label.schoolNotice.board.writer" />: <form:input
					readonly="true" value="${member.loginId}" path="id_writer" />
				<br />
				<spring:message code="label.schoolNotice.board.title" />: <form:input
					path="title" />
				<br />
				<spring:message code="label.schoolNotice.board.contents" />
				<br />
